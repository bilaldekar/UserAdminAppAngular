...
describe('user list component', function () {
    ...
    it('should call get users in user service', function () {
        mockUserService.getUsers.and.returnValue(of(USERS));
        fixture.detectChanges();
        expect(mockUserService.getUsers).toHaveBeenCalled();
    });
    it('selected filter initial value should be active', function () {
        expect(fixture.componentInstance.selectedValue).toBe('Active');
    });
    it('should create one row for each user', function () {
        mockUserService.getUsers.and.returnValue(of(USERS));
        fixture.detectChanges();
        var listElement = fixture.debugElement.queryAll(By.css('div.firstname'));
        expect(listElement.length).toBe(2);
    });
    it('first row should display the user with firstname bilal', function () {
        mockUserService.getUsers.and.returnValue(of(USERS));
        fixture.detectChanges();
        var listElement = fixture.debugElement.queryAll(By.css('div.firstname'));
